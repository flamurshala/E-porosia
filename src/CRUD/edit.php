...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `users` SET `first_name`='$first_name',`last_name`='$last_name',`email`='$email',`password`='$password',`role`='$role' WHERE id = $id";
...
<body>
  ...
  <div class="container">
    <div class="text-center mb-4">
      <h3>Perditeso te dhenat e perdoruesit</h3>
      <p class="text-muted">Kliko ne butonin perditso per ti perditsuar te dhenat</p>
    </div>
